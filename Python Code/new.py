...
class Ui_MainWindow(object):
    ...
    def file_save(self):
        ...
        # print(HOST_PRO)
        self.c.execute("INSERT INTO Visitor values (%s,%s,%s,%s,%s,%s,%s)",(NAME_PRO,ADDRESS_PRO,MOBILE_NO_PRO,EMAIL_PRO,HOST_PRO,now,''))
        
        
        data1=['Name:', 'Phone:' ,'Email:','Address:']
        q="SELECT Name,Phone,Email,Address FROM Visitor where Name='{}' "
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.INFO.setText(_translate("MainWindow", "YOU CLICKED ON : CHECK IN"))
